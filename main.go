...
func main() {
	remoteAPIURL := "https://blasterproducts.com/blaster_corporation_material_safety_data_sheets/" // URL to fetch HTML content from
	localFilePath := "blasterproducts.html"                                                        // Path where HTML file will be stored
